...
// Functions imported from stl wrapper dll
// these functions have to be compiled with VC++ 7.1
namespace stl_71_wrapper
{
	extern "C"
	{
		__declspec(dllimport) void map_insert(void* pMap, const char* key, void* val);
		__declspec(dllimport) void* map_find(void* pMap, const char* key);
	}
}